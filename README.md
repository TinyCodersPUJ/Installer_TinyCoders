...
- Dentro del archivo _setup.iss_ encontrará el código fuente de creación del instalador, en este encontrará resaltado con comentarios las rutas que deberá ajustar en caso de ser necesario dentro de su dispositivo para poder seguri trabajando en el instalador, además de información importante con respecto las propiedades de los instaladores generados, como el nombre y la versión. Para más información, consulte la documentación de Inno Setup [aqui](https://jrsoftware.org/isinfo.php).
